...
class IdNames  {
    companion object {
        ...
        val data_string: String = "ДАННЫЕ"
        val settings_string: String = "ОБЩИЕ НАСТРОЙКИ"
        val climate_string: String = "НАСТРОЙКИ КЛИМАТА"
        val startApp_string: String = "ЗАПУСК ПРИЛОЖЕНИЙ"
        ...
        val summer_mode_windows_key: String = "summer_mode_windows_enabled"
        val summer_mode_fl_key: String = "summer_mode_fl_enabled"
        val summer_mode_fr_key: String = "summer_mode_fr_enabled"
